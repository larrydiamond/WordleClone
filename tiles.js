...
class ButtonA extends React.Component {
    ...
    constructor(props) {
        ...
        const wordList = new Array(
            ...
            "JOINT","JUDGE",
            "KNEAD",
            "LARGE","LAYER","LABOR","LAPSE","LAUGH","LATER",
            "LEARN","LEAST","LIGHT","LOWER","LOGIC","LUCKY","LUNCH","LYING",
            "MAGIC","MACHO","MARCH","MATCH","MAYBE","MAYOR",
            "METAL","MEDIA",
            "MINUS","MIXED","MIGHT",
            "MODEL","MONTH","MOUNT","MORAL","MOUSE","MOUTH","MOVIE","MOIST","MOURN",
            "MUSIC",
            "NACHO","NASTY",
            ...
            "VOWEL","VIRAL",
            "WAIST","WATCH","WATER",
            "WEIGH","WHILE","WIDTH","WORLD","WRITE","WOMAN","WRONG","WHACK","WINCE",
            "YEAST","YACHT",
            );
